...
fh = open('SQL_Passwd.txt')
passwd = fh.readlines()[1].strip('\n')
fh.close()
...
#Background
bg = 'Bg.png'
bg_image = pygame.transform.scale(pygame.image.load('FrontPage\\Bg.png').convert_alpha(),(width, height))
...
#Music
Bg_Music = pygame.mixer.music.load('Memory_cards\\Sounds\\Bg_Music.mp3')
