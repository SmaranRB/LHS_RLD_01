...
def Background(Width = 800 ,Height = 400):
    Bg =  pygame.transform.scale(pygame.image.load('Assets\\Bg\\Bg6.jpg').convert_alpha(),(Width,Height))
...
def Load_Images(Width,Height,screen):
    ...
    L = ['Animals\\Koala','Animals\\Tiger']
    File_Selected = random.sample(L, 1)[0]
    if File_Selected == 'Animals\\Koala':
        File_Selected_2 = 'Animals\\Tiger'

    else:
        File_Selected_2 = 'Animals\\Koala'
