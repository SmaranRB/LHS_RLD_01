...
def main():
   ...
   while run:
      ...
      screen.blit(pygame.transform.scale(pygame.image.load('FrontPage\\Bg.png').convert_alpha(),(1280, 720)),(0,0))

      Font_Head = pygame.font.Font('Memory_cards\\Fonts\\Quicksand\\Quicksand-Bold.otf',70)
      screen.blit(Font_Head.render("Progress Report", 1, Init.Purple) , (Font_Head.render("Progress Report", 1, Init.White).get_rect(center = (width//2,height//8))))
